...
var DevolutionRentalUseCase = /** @class */ (function () {
    ...
    DevolutionRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var rental, car, minimum_daily, dateNow, endDate, daily, delay, total, calculate_fine;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        minimum_daily = 1;
                        if (!rental)
                            throw new AppErros_1.AppErros('Rental does not exists');
                        ...
                        if (daily <= 0)
                            daily = minimum_daily;
                        delay = this.dateProvider.compareInDays(dateNow, endDate);
                        total = 0;
                        if (delay > 0) {
