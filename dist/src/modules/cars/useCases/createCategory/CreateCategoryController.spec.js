...
var index_1 = __importDefault(require("../../../../shared/infra/typeorm_database/index"));
var connection;
describe('Create Category Controller', function () {
    ...
    it('should be able a new category', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should not be able a new category with name exists', function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, refresh_token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post('/sessions').send({
