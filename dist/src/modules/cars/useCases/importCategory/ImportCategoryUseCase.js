...
var fs_1 = __importDefault(require("fs")); // modulo nativo do node
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        categories.map(function (category) { return __awaiter(_this, void 0, void 0, function () {
                            var name, description, categoryAlreadyExists;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        categoryAlreadyExists = _a.sent();
                                        if (!!categoryAlreadyExists) return [3 /*break*/, 3];
