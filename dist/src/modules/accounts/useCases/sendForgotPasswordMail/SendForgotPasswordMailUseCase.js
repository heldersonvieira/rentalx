...
var SendForgotPasswordMailUseCase = /** @class */ (function () {
    function SendForgotPasswordMailUseCase(usersRepositoru, usersTokensRepository, dayjsDateProvider, MailProvider) {
    ...
    SendForgotPasswordMailUseCase.prototype.execute = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersRepositoru.findByEmail(email)];
                    case 1:
                        user = _a.sent();
                        templatePath = (0, path_1.resolve)(__dirname, '..', '..', 'views', 'emails', 'forgotPassword.hbs');
                        if (!user)
                            throw new AppErros_1.AppErros('Users does not exists');
                        token = (0, uuid_1.v4)();
