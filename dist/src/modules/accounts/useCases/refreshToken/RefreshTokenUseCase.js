            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        userToken = _b.sent();
                        if (!userToken)
                            throw new AppErros_1.AppErros('Refresh token does not exists');
                    ...
                    case 2:
                        ...
                        expires_date = this.dayjsDateProvider.addDays(auth_1.default.expires_refresh_token_days);
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, { token: newToken, refresh_token: refresh_token }];
                }
            });
        });
    };
